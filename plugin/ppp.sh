...
# which aliroot
aliroot -b -q -l 'runGrid_LHC10f6a.C' || exit
#aliroot -b -q -l 'runGrid_LHC13b2_efix_p1.C' || exit
#aliroot -b -q -l 'runGrid_LHC13g.C' || exit
...
#aliroot -b -q -l runGrid_LHC11b10a_AOD116.C || exit
#aliroot -b -q -l runGrid_LHC10f6a.C || exit
