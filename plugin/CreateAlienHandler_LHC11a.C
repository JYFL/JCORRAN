AliAnalysisGrid* CreateAlienHandler()
{
  ...
  plugin->SetRunPrefix("000");   // real data
    ...
    //plugin->SetDataPattern("ESDs/pass2_without_SDD/*ESDs.root");
    ///alice/data/2011/LHC11a/000146824/ESDs/pass4_without_SDD/AOD113/0323/
    plugin->SetGridDataDir("/alice/data/2011/LHC11a");
    plugin->SetDataPattern("*/pass4_without_SDD/AOD113/*/AliAOD.root";
...
//  plugin->SetAdditionalLibs("PWG4JCORRAN.par libEMCALUtils.so libPHOSUtils.so");//AliCentralityBy1D_137161_GLAU.root AliCentralitySelectionTask.cxx");
  ...
  //========================================
  plugin->SetGridWorkingDir("PROD20131218/LHC11a-AOD113-");
