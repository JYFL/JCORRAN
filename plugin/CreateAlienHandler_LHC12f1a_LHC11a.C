AliAnalysisGrid* CreateAlienHandler()
{
  ...
  plugin->SetGridDataDir("/alice/sim/2012/LHC12f1a");
  ///alice/sim/2013/LHC13b2_efix_p1/195346/AOD/066/
  plugin->SetDataPattern("/AOD128/*AliAOD.root");
  ...
  //========================================
  plugin->SetGridWorkingDir("Efficiency/LHC12f1a_v5-05-42-AN_r2078_test");
