...
void runGrid_LHC12a17d_fix(){
    ...
    gROOT->LoadMacro("./CreateAlienHandler_LHC12a17d_fix_AOD124_0to10_fullTPCFlow.C");
    ...
    triggerSelection =  AliVEvent::kINT7;
    //    | AliVEvent::kINT7;
    //										| AliVEvent::kHighMult 
    //										| AliVEvent::kEMCEGA;
    //										| AliVEvent::kEMCEJE
    ...
    if(IsMC) triggerSelection = 0;//AliVEvent::kAny; 
	...
	hdr->SetRunType("LHC12a17d_fix");
	hdr->SetInputFormat( 1 ); // 0: ESD; 1: AOD
