...
void runGrid_PbPb_MC(){
    ...
    physSelTask->SelectCollisionCandidates(0);

    //==== CENTRALITY
    gROOT->LoadMacro("$ALICE_ROOT/ANALYSIS/macros/AddTaskCentrality.C");
    AliCentralitySelectionTask *taskCentrality = AddTaskCentrality(); 
    taskCentrality->SelectCollisionCandidates(0);
    ...
    */
    ...
    //==== JCORRAN TASK
    AliJCORRANTask *jctask = new AliJCORRANTask("PWGJCORRANTask",kJCORRANInputFormat);
    ...
    //==event selection
    jctask->SelectCollisionCandidates( 0 );  //Apply offline trigger selection by AliPhysicsSelectionTask
    ...
    AliAnalysisDataContainer *effHist = mgr->CreateContainer("EffHist",  TDirectory::Class(), AliAnalysisManager::kOutputContainer, "jcorran.root");
